...
def register_tango_sidebar_callbacks(app):
    # Register callbacks for motl loads:
    register_motl_load_callbacks(app, "main")
    register_motl_load_callbacks(app, "nn")
    register_motl_save_callbacks(app, "save-main", stored_outputs, "tabv-motl-global-data-store", "main")
