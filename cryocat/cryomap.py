...
def scale(input_map, scaling_factor, output_name=None):
    ...
    scaling_factor : float
        The factor by which to scale the input map. If the scaling factor is greater than 1, anti-aliasing is turned off.
    output_name : str, optional
        The name of the output file to which to write the scaled map. If not provided, the scaled map is not written to a file.
    ...
    Notes
    -----
    The map is scaled using the transform.rescale function from the skimage library, with order set to 3 and mode set to "reflect".
    """
